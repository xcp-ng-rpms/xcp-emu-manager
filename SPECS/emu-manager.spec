...
%changelog
* Fri Feb 13 2026 Lucas Pottier <lucas.pottier@vates.tech> - 1.2.1-1
- Fix suspend condition to handle -1 remaining dirty pages
- Send pause command sooner, before suspending
